...
#define ADC_RAW_MAX 4095u  // 12 bit converter

// condition bands to use for indication in lamps
...
// outside this band the signal chain is broken and not a valid temperature to consume
#define TEMP_MIN_PLAUSIBLE_MDC DEGC(-40)
#define TEMP_MAX_PLAUSIBLE_MDC DEGC(200)

#define FAULT_BLINK_HALF_PERIOD_MS 250u  // 2 Hz

// Few assertions to make sure modification in these will lead failures if not followed with below conditions
